            ...
            <div className="mt-24 mx-auto w-8/12 p-6 bg-white border border-gray-200 rounded-lg shadow bg-gray-800 border-gray-700 text-white">
                <div className="grid w-fill gap-6 mb-6 md:grid-cols-2">
                    <div>
                        ...
                        <select value={fasceOrarie} onChange={(e) => setFasceOrarie([e.target.value])} id="fasceOrarie" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 bg-gray-700 border-gray-600 placeholder-gray-400 text-white focus:ring-blue-500 focus:border-blue-500">
                    ...
                    <>
                        {
                            ristoranti.map((ristorante) => {
                                return (<CardRistorante ristorante={ristorante}  />)
                            })
                        }
                    </>
                </div>
